    ...
    <div className='bg-[#121121] pb-[3rem] pt-[4rem] md:pt-[8rem]' id='About'>
      <div className='grid grid-cols-1 md:grid-cols-2 w-[80%] mx-auto gap-[3rem] items-center'>
        <motion.div
          ...
          variants={fadeInLeft}
        >
          <h1 className='text-[20px] font-bold uppercase text-[#55e6a5] mb-[1rem]'>About</h1>
          <h2 className='text-[25px] md:text-[35px] lg:text-[45px] md:leading-[3rem] capitalize
          ...
          <div className='mb-[2rem] mt-2 flex items-center md:space-x-0'>
            <p className='text-[19px] text-slate-300 w-[80%] text-balance md:text-justify'>
              Dynamic Next.js developer skilled in HTML, CSS, JavaScript, and TypeScript.
              Expert in React.js and Tailwind CSS. Proficient in integrating headless CMS like Sanity.
              Passionate about crafting scalable, user-friendly web applications.
              Ready to collaborate in an innovative environment.
            </p>
          </div>
