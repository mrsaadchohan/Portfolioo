        ...
        >
          ...
          <div className="mb-[2rem] mt-2 flex items-center md:space-x-0">
            <p className="text-[19px] text-slate-300 w-[80%] text-balance md:text-justify">
              Dynamic Next.js developer skilled in HTML, CSS, JavaScript, and
              TypeScript. Expert in React.js and Tailwind CSS. Proficient in
              integrating headless CMS like Sanity. Passionate about crafting
              scalable, user-friendly web applications. Ready to collaborate in
